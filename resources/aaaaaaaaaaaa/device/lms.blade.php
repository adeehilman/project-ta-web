                            ...
                            <form id="formDaftar" method="POST">
                                ...
                                <div id="section__one">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="txBadge" name="txBadge" class="form-control" placeholder="Masukkan nomor badge" autocomplete="off">
                                ...
                                <div id="section__two">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="txTipeLaptop" name="txTipeLaptop" class="form-control" placeholder="Masukkan Tipe Laptop">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="txNoSerial" name="txNoSerial" class="form-control" placeholder="Masukkan Barcode Label">
                                            <span id="errNoSerial" class="text-danger"></span>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="">Alasan Permintaan</label>
                                            <select class="form-select" id="selectAlasanPermintaan" name="selectAlasanPermintaan">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="txAssetNumber" name="txAssetNumber" class="form-control" placeholder="Masukkan Asset Number">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-select" id="selectDurasiPemakaian" name="selectDurasiPemakaian">
                                            </select>
                                            <span id="errNoSerial" class="text-danger"></span>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div id="containerDateDurasi" class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="txMulaiMemakai" name="txMulaiMemakai" class="form-control dateMulai">
                                            <span id="errMulaiMemakai" class="text-danger"></span>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="">Selesai Memakai</label>
                                            <input type="text" id="txSelesaiMemakai" name="txSelesaiMemakai" class="form-control dateAkhir">
                                ...
                                <div id="section__three">
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <img id="containerGambarDpn" class="img-thumbnail border-0 rounded-3 mb-2 fw-bold imgView" width="80" src="" alt="image depan">
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <img id="containerGambarBlkng" class="img-thumbnail border-0 rounded-3 mb-2 fw-bold imgView" width="80" src="" alt="image belakang">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer section-btn-modal d-flex justify-content-between">
                                    <div class="section-btn-modal__left">
                                        <p class="mt-2"><span id="currentNumber" class="fw-bold">1</span> / 3 <span id="currentText">Informasi Karyawan</span></p>
                                    </div>
                                    <div class="section-btn-modal__left">
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" style="height: 600px;">
                <div class="modal-content">
                        ...
                        <div id="section__view__infomasiperangkat" style="height: 500px">
                            <div class="row mx-2 my-2">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="d-flex">
                                        <p class="mb-2" id="txViewDeviceNumber"></p><button id="btnEditBarcodeLabel" class="ms-2 btn btn-outline-secondary btn-sm"><i class="bx bx-edit"></i></button>
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btnTolakPengajuan" type="button" class="btn btn-link" style="text-decoration: none">Tolak Pengajuan</button>
        ...
        <script>
            ...
            pageBody.on('click', '.btnView', function(e){
                ...
                if(dataId){
                    ...
                    $.ajax({
                        ...
                        let newDate2 = `${date2.getDate()} ${arrMonth[date2.getMonth()]} ${date2.getFullYear()}`;
                        ...
                        if(res.dataRiwayat.length > 0){
                            ...
                            if(res.dataRiwayat[containerRiwayatStatusLength-1].stat_title === "Selesai" || res.dataRiwayat[containerRiwayatStatusLength-1].stat_title === "Revoke" || res.dataRiwayat[containerRiwayatStatusLength-1].stat_title === "Expired"){
                        ...
                        const statusId = res.dataLMS[0].status_pendaftaran_lms_id ? parseInt(res.dataLMS[0].status_pendaftaran_lms_id) : 0;
            ...
            $('#btnUpdateBarcodeLabel').click(async e=>{
                ...
                $.ajax({
                    ...
                    method: 'get', 
                    dataType: 'json',
                    data: {valLMSId, txUpdateBarcodeLabel},
                }).done(res => {
                    if(res.status === 400){
                        showMessage('error', res.message)
                        return;
