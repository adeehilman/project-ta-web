                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 my-auto" style="font-size: 13px">
                                            <div class="list__bullet">
                                                ...
                                                <span> 17-20 Tahun <span
                                                        style="color: #4AC571">{{ $dataRentangUsia[0]->umur_17_sampai_20 }}
                                                    </span>
                                                    <span>
                                                        @php
                                                            $pembilang = $dataRentangUsia[0]->umur_17_sampai_20;
                                                            $penyebut = $dataRentangUsia[0]->umur_17_sampai_20 + $dataRentangUsia[0]->umur_21_sampai_30 + $dataRentangUsia[0]->umur_31_sampai_40 + $dataRentangUsia[0]->umur_41_sampai_50 + $dataRentangUsia[0]->umur_51_sampai_60;
...
@section('script')
    ...
    <script>
        ...
        var optionsRentangUsia = {
            series: [{{ $dataRentangUsia[0]->umur_17_sampai_20 }}, {{ $dataRentangUsia[0]->umur_21_sampai_30 }},
                {{ $dataRentangUsia[0]->umur_31_sampai_40 }}, {{ $dataRentangUsia[0]->umur_41_sampai_50 }},
                {{ $dataRentangUsia[0]->umur_51_sampai_60 }}
            ],
            labels: ['17-20 Tahun', '21-30 Tahun', '31-40 Tahun', '41-50 Tahun', '51-60 Tahun'],
            chart: {
                type: 'donut',
                //   height: 200, 
                sparkline: {
