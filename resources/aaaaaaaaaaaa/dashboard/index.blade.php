                            ...
                            <div class="card shadow border-0">
                                <div class="card-body">
                                    ...
                                    <div class="text-nowrap">
                                        <i class="bx bx-line-chart text-success"></i>
                                        <span
                                            class="badge badge-soft-success text-success">{{ number_format($persentaseKenaikanPeminjam, 2) }}
                                            %</span>
                                        <span class="ms-1 text-muted font-size-13">Dari Bulan lalu</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6 my-auto" style="font-size: 13px">
                                            <div class="list__bullet">
                                                ...
                                                <span> 18-20 Tahun <span
                                                        style="color: #4AC571">{{ $dataRentangUsia[0]->umur_18_sampai_20 ? $dataRentangUsia[0]->umur_18_sampai_20 : 0 }}
                                                    </span>
                                                    <span>
                                                        @php
...
@section('script')
    ...
    <script>
        ...
        var optionsLaptop = {
            series: [{{ $totalWorkerWorkingLMS }}, {{ $totalJangkaPanjangLMS }}],
            labels: ['Untlimated Duration', 'Jangka Panjang'],
            chart: {
                type: 'donut',
                //   height: 200, 
                sparkline: {
