        ...
        <div class="wrapper_content">
            ...
            <div class="row me-1">
                ...
                <div class="col-sm-12 mt-2 d-flex justify-content-between">
                    ...
                    <div class="d-flex gap-1">
                        <button id="btnTambahKaryawan" type="button" class="btn btn-outline-danger rounded-3 align-self-center">
                            <i class="bx bx-user-plus"></i>
                            Tambah
                        </button>
                        {{-- <button id="btnImportKaryawan" type="button" class="btn btn-outline-danger rounded-3 align-self-center">
                            <i class="bx bx-download"></i>
                            Export Data
                        </button> --}}
                        <button id="btnImportRFID" type="button" class="btn btn-outline-danger rounded-3 align-self-center">
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    setTimeout(() => {
                        ...
                        Swal.fire({
                            title: 'Apakah anda ingin untuk mendaftarkan mms?',
                            icon: 'question',
                            showCancelButton: true,
                            confirmButtonColor: '#d33',
                            cancelButtonColor: '#6e7881',
