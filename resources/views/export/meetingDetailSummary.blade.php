...
<tr>
    <td style="width: 250px;"><b>Employee No</b></td>
    <td>{{ $ParticipantBadge }}</td>
    <td></td>
</tr>
<tr>
    <td style="width: 250px;"><b>Department</b></td>
    <td>{{ $DeptName }}</td>
    <td></td>
</tr>

<tr>
    <td style="width: 250px;"><b>Total Meetings</b></td>
    <td style="text-align: left">{{ $TotMeeting }}</td>
    <td></td>
</tr>
<tr>
    <td style="width: 250px;"><b>Total Attendance</b></td>
    <td style="text-align: left">{{ $Kehadiran }}</td>
    <td></td>
</tr>
<tr>
    <td style="width: 250px;"><b>Total Absent</b></td>
