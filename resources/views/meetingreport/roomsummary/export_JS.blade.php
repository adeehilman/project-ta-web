<script>
    ...
    btnExport.click(e => {
        ...
        Swal.fire({
            title: "Do you want to Export Room Summary?",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('/roomsummary/export') }}", // Ganti dengan URL yang sesuai
                    type: 'GET',
                    data: {
                        txSearch: txtSearch,
                        tahunDropdown,
                    ...
                    success: function(response) {
                        ...
                        link.href = blobUrl;
                        link.download = 'Room_Summary_Report.xlsx';
                        document.body.appendChild(link);
                        link.click();
                        document.body.removeChild(link);

                        showMessage('success', "Room Summary was succesfully export!")
