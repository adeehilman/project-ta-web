@extends('layouts.app')
@section('title', 'Detail Room Summary')
...
@section('content')
        ...
        <div class="wrapper_content">
            ...
            <div class="modal fade" data-bs-backdrop="static" id="modalDetail" tabindex="-1">
                <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered" style="height: 600px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 fw-bold" id="modalDetailTitle">Detail Room</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body" style="font-size: 16px;">
                                                ...
                                                <div class="col-sm-12">
                                                    <table id="infobooking" class="ms-2"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="ProjectNameDetailTextRoomSummary"
                                                                style="color: black;">
                                                            </td>
                                                        </tr>
            ...
            <div class="row me-1">
                <div class="col-sm-6">
                    <a href="{{ route('roomsummary') }}" style="text-decoration: none">
                        <span class="text-muted fs-6">
                            <img src="{{ asset('icons/left.svg') }}"> Back to Room Summary</span>
                    </a>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        ...
                        <table class="ms-2" style="font-size: 16px; line-height: 2;">
                            <tr>
                                <td style="width: 300px; color: gray;">Room</td>
                                <td id="Fullname" style="color: black;">{{ $total->room_name }}</td>
                            </tr>
                            <tr>
                                <td style="width:  300px; color: gray;">Time</td>
                                <td id="EmployeeNo" style="color: black;">{{ $time }}</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 300px; color: gray;">Total Meetings</td>
                                <td id="DeptName" style="color: black;">{{ $total->meeting_count }}</td>
                            </tr>
    ...
    @include('meetingreport.roomsummary.detailsummary.infoDetail_JS')
    @include('meetingreport.roomsummary.detailsummary.export_JS')
