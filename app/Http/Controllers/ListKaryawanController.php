...
class ListKaryawanController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'positionName' => DB::table('tbl_rolemeeting')->select('name')->where('id', session()->get('loggedInUser')['session_roles'])->first()->name,
        ];
    ...
    public function employee_list(Request $req)
    {
        ...
        a.gender,
        (SELECT name FROM tbl_gender WHERE id=a.gender) AS jenis_kelamin,
        a.no_hp,
        a.no_hp2,
        a.home_telp,
        a.createby,
