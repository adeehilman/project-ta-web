...
class MMSController extends Controller
{
    ...
    public function mms_list(Request $req)
    {
        ...
        if($data){
            ...
            foreach($data as $row){
                ...
                $output .= 
                '
                <tr class="viewMMS" data-id="' . $row->id . '" style="color: black;">
                    <td class="p-3">' . $row->badge_id . '</td>
                    <td class="p-3">' . $row->fullname . '</td>
                    <td class="p-3">' . $row->dept_name . '</td>
                    <td class="p-3">' . $row->merek_hp . '</td>
                    <td class="p-3">' . $row->tipe_hp . '</td>
                    <td class="p-3">' . $row->imei1 . '</td>
                    <td class="p-3">' . $row->jenis_permohonan . '</td> 
                    <td class="p-3">' . date('d M Y', strtotime($row->waktu_pengajuan)) . '</td>
                    <td class="p-3">' . $row->status_pendaftaran_mms . '</td>
                    <td>
    ...
    public function check_barcode_label(Request $req)
    {
        ...
        $countqBarcodeLabel = DB::table('tbl_mms')->where('barcode_label', $barcodeLabel)->where('is_active', '1')->count();
    ...
    public function update_pengajuan_mms(Request $req)
    {
        ...
        $oldDataStatusMMS = DB::table('tbl_mms')->select('status_pendaftaran_mms')->where('id', $mmsId)->first();
        $oldStatusMMS = '';
        if($oldDataStatusMMS){
                ...
                if($setStatus == "tolak"){
                    ...
                    if($roles == 63){
                        ...
                        if($oldStatusMMS == 2){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms'=> 3]);
                    ...
                    if($roles == 64){
                        ...
                        if($oldStatusMMS == 4 || $oldStatusMMS == 2){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 5]);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 5,
                    ...
                    if($roles == 65){
                        ...
                        if($oldStatusMMS == 7){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 8]);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 8,
                    ...
                    if($roles == 66){
                        ...
                        if($oldStatusMMS == 9 || $oldStatusMMS == 7){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 10]);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 10,
                    ...
                    if($roles == 63){
                        ...
                        if($oldStatusMMS == 2){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms'=> '4']);
                    ...
                    if($roles == 64){
                        ...
                        if($oldStatusMMS == 2 || $oldStatusMMS == 4){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 7]);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 6,
                    ...
                    if($roles == 65){
                        ...
                        if($oldStatusMMS == 7){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 9]);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 9,
                    ...
                    if($roles == 66){
                        ...
                        if($oldStatusMMS == 7 || $oldStatusMMS == 9){
                            ...
                            DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 12, 'is_active' => '1']);
                            $riwayat = [
                                [
                                    'id_mms' => $mmsId,
                                    'status_mms' => 11,
                    ...
                    //         DB::table('tbl_mms')->where('id', $mmsId)->update(['status_pendaftaran_mms' => 15]);
                    //         $riwayat = [
                    //             [
                    //                 'id_lms' => $mmsId,
                    //                 'status_lms' => 14,
    ...
    public function set_inactive_mobile(Request $req)
    {
        ...
        try {
            ...
            // dd($valMMSId);
            DB::table('tbl_mms')->where('id', $valMMSId)->update([
                'is_active' => $status,
            ...
            // if($status){
            // }else{
            //     DB::table('tbl_mms')->where('id', $valMMSId)->update(['is_active' => $status]);
            // }
    ...
    public function update_barcode_label(Request $req)
    {
        ...
        try {
            ...
            $check = DB::table('tbl_mms')->where('barcode_label', $txUpdateBarcodeLabel)->count();
    ...
    public function update_uuid(Request $req)
    {
        ...
        try {
            ...
            $check = DB::table('tbl_mms')->where('uuid', $txUpdateUUID)->count();
    ...
    public function update_tipe_hp(Request $req)
    {
        ...
        try {
            ...
            // $check = DB::table('tbl_mms')->where('tipe_hp', $txUpdateTipeHp)->count();
